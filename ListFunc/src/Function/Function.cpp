...
std::unique_ptr<Expression> Function::call(const std::vector<const Expression*>& args) const {
...
std::unique_ptr<Expression> Function::operator()(const std::vector<const Expression*>& args) const {
    return call(args);
}
